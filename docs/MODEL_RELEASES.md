...
5. Push a tag such as:
   ```bash
   git tag models-ppocrv5-v4
   git push origin models-ppocrv5-v4
   ```
...
```text
https://github.com/zxc88645/ffocr/releases/download/models-ppocrv5-v4
```
...
3. Push a new tag such as `models-ppocrv5-v4`
